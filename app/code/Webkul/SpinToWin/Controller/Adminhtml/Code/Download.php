...
use Webkul\SpinToWin\Controller\Adminhtml\Action as CodeAction;
use Webkul\SpinToWin\Model\SampleFileProvider;

/**
 * Download sample file controller
 */
class Download extends CodeAction implements HttpGetActionInterface
{
