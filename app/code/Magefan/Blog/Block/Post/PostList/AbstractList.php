...
abstract class AbstractList extends Template implements IdentityInterface
{
    ...
    const POSTS_SORT_FIELD_BY_UPDATE_TIME = 'update_time';
    ...
    protected function _preparePostCollection()
    {
        $this->_postCollection = $this->_postCollectionFactory->create()
            ...
            ->setOrder($this->getCollectionOrderFieldForModified(), $this->getCollectionOrderDirection());
    ...
    /**
     * Retrieve collection order field by modified
     *
     * @return string
     */
    public function getCollectionOrderFieldForModified()
    {
        return self::POSTS_SORT_FIELD_BY_UPDATE_TIME;
    }
