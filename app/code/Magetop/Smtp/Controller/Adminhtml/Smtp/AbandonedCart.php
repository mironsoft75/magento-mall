...
class AbandonedCart extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Magetop_Smtp::abandoned_cart';
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Magetop_Smtp::abandoned_cart');
        $resultPage->getConfig()->getTitle()->prepend(__('Abandoned Carts'));
        //Add bread crumb
        $resultPage->addBreadcrumb(__('Magetop'), __('Magetop'));
        $resultPage->addBreadcrumb(__('Smtp'), __('Abandoned Carts'));
